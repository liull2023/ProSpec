...
class Logger(object):
    def __init__(self, log_dir, use_tb=True, use_wandb=False, config='rl',log_i=0):
        ...
        if use_tb:
            ...
            self._sw = None
        self._train_mg = MetersGroup(os.path.join(log_dir, f'train_info{log_i}.log'),
                                     formating=FORMAT_CONFIG[config]['train'])
        self._eval_mg = MetersGroup(os.path.join(log_dir, f'eval_info{log_i}.log'),
