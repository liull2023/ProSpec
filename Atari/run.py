...
def build_and_train(game="pong", run_ID=0, cuda_idx=0, args=None):
    ...
    wandb.log({"total_time_sec": total_elapsed})
    quit()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--public', action='store_true', help='If set, uses anonymous wandb logging', default=True)
    parser.add_argument('--real-cycle', action='store_true')
    parser.add_argument('--virtual-cycle', action='store_true', default=True)
