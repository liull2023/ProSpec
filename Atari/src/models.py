        ...
        if train:
            ...
            if self.forward_predict:
                ...
                if self.real_cycle:
                    ...
                    for i in reversed(range(1, 1 + self.cycle_step)):
                        ...
                        recon_latents = self.backward_dynamics_model(recon_latents, actions, invert=True)
            ...
            if self.backward_predict:
                ...
                for i in reversed(range(1, 1 + self.jumps)):
                    ...
                    cur_actions = prev_action[i]
                    cur_latents = self.backward_dynamics_model(cur_latents, cur_actions, invert=True)
